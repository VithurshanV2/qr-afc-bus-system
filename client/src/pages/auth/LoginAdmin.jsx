...
const LoginBusOperator = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(backendUrl + '/api/auth/login-admin', {
        email,
        password,
      });
      ...
      if (data.success) {
        setIsLoggedIn(true);
        await getUserData();
        navigate('/admin/review-account-request');
      } else {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div
        ...
        bg-gradient-to-br from-cyan-100 to-gray-900"
      >
        <img
          onClick={() => navigate('/')}
          src={assets.logo}
        ...
        />
        <div className="bg-dark-bg p-10 rounded-lg shadow-lg w-full sm:w-96 max-w-[384px] text-cyan-100 text-sm">
          ...
          <form onSubmit={onSubmitHandler}>
            ...
            <div className="mb-4 relative flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-input-bg">
              ...
              <button
                ...
                className="absolute right-4 text-xs text-cyan-200 hover:text-cyan-100 transition"
            ...
            <p
              ...
              className="mb-4 text-cyan-200 cursor-pointer"
            >
              Forgot password?
            </p>
            ...
            <button
              ...
              className={`w-full py-2.5 rounded-full font-medium ${
                globalLoading
                  ...
                  : 'bg-gradient-to-r from-cyan-600 to-gray-800 text-white shadow-md hover:shadow-cyan-800 hover:brightness-110 hover:scale-105 active:scale-100 transition-all duration-300 transform'
              }`}
            >
              Login
            </button>
